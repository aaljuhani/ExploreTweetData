...
#source : https://github.com/rafacarrascosa/countminsketch/blob/master/countminsketch.py
class CountMinSketch(object):
    ...
    def saveDataToFile(self,filename):
        """
        a methode to set self.table to data of specific file
        :param filename:
        :return:
        """
        with open('data/'+filename, 'wb') as fp:
            pickle.dump(self.tables, fp)

    def loadDataToTables(self, filename):
        """
        load saved data to tables object
        :param filename:
        :return:
        """
        ''' check if file exist'''
